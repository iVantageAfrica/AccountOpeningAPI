...
@section('mailContent')
    <div style="padding: 0px 25px;">
        ...
        <p style="line-height: 30px; font-size: 16px; margin: 0; padding: 25px 0px 15px 0px;">
            ...
            A customer has successfully submitted an Account Information Update request through
            the
        ...
        <table role="presentation"
            ...
            <tr>
                <td
                    style="width: 50%; background-color: #f4f4f5; border-radius: 8px; padding: 10px 12px; vertical-align: top;">
                    <p style="font-size: 12px; color: #8d91a0; margin: 0 0 2px;">Updated Email Address
                    </p>
                    <p
                        style="font-size: 14px; font-weight: 500; font-family: monospace; margin: 0;">
                        {{ $accountUpdateData->email_address }}</p>
                </td>
                <td
                    style="width: 50%; background-color: #f4f4f5; border-radius: 8px; padding: 10px 12px; vertical-align: top;">
                    <p style="font-size: 12px; color: #8d91a0; margin: 0 0 2px;">Updated Phone
                        Number
                    </p>
                    <p
                        style="font-size: 14px; font-weight: 500; font-family: monospace; margin: 0;">
                        {{ $accountUpdateData->phone_number }}</p>
                </td>
            ...
            <tr>
                <td
                    style="width: 50%; background-color: #f4f4f5; border-radius: 8px; padding: 10px 12px; vertical-align: top;">
                    <p style="font-size: 12px; color: #8d91a0; margin: 0 0 2px;">Updated Account
                        Officer
                    </p>
                    <p
                        style="font-size: 14px; font-weight: 500; font-family: monospace; margin: 0;">
                        {{ $accountUpdateData->account_officer }}</p>
                </td>
                <td
                    style="width: 50%; background-color: #f4f4f5; border-radius: 8px; padding: 10px 12px; vertical-align: top;">
                    ...
                    <p
                        style="font-size: 14px; font-weight: 500; font-family: monospace; margin: 0;">
                        {{ $accountUpdateData->created_at }}</p>
                </td>
            </tr>
        ...
        <p style="line-height: 30px; font-size: 16px; margin: 0 0 16px;">
            Kindly review the submitted update request and verify the information provided by the customer.
        </p>
        ...
        <ul style="margin: 0 0 20px; padding-left: 20px;">
            <li style="font-size: 14px; line-height: 28px; margin-bottom: 4px;">A PDF summary of the customer's submission is attached to this email</li>
            <li style="font-size: 14px; line-height: 28px; margin-bottom: 4px;">Supporting documents submitted by the customer (if applicable) are attached</li>
            <li style="font-size: 14px; line-height: 28px; margin-bottom: 4px;">The update request can also be viewed from the customer management dashboard</li>
        </ul>
        ...
        <ul
            ...
            <li style="font-size: 14px; line-height: 28px; color: #8d91a0; margin-bottom: 4px;">This request was initiated directly by the customer through the approved self-service platform</li>
            <li style="font-size: 14px; line-height: 28px; color: #8d91a0; margin-bottom: 4px;">All submitted information has been logged for audit purposes</li>
            <li style="font-size: 14px; line-height: 28px; color: #8d91a0; margin-bottom: 4px;">Appropriate verification should be completed before updating the customer's profile on the Core
                Banking Application (CBA)</li>
