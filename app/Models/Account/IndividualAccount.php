 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|IndividualAccount whereCity($value)
 * @method static \Illuminate\Database\Eloquent\Builder<static>|IndividualAccount whereState($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|IndividualAccount whereHouseNumber($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|IndividualAccount whereStreet($value)
...
class IndividualAccount extends Model
{
    ...
    use SoftDeletes;
    protected $fillable = [
        'user_id', 'account_type_id','account_number','mother_maiden_name','phone_number','employment_status',
        'marital_status', 'house_number','street', 'city', 'state', 'next_of_kin_name','next_of_kin_address','next_of_kin_relationship',
        'next_of_kin_phone_number', 'document_id', 'referees','debit_card',
    ];
